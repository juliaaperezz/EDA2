//Esta abajo el menú, era para ver si se puede cargar usuario de csv, pero no puc
...
// Declaración de funciones submenú
void submenuUsuario(Usuario usuarios[], int contadorUsuarios, int indiceUsuario);
void enviarSolicitudAmistad(Usuario usuarios[], int contadorUsuarios, int indiceUsuario);
void gestionarSolicitudesPendientes();
void realizarPublicacion(int indiceUsuario);
void listarPublicaciones(Usuario usuarios[], int contadorUsuarios, int indiceUsuario);
...
void mostrarMenuPrincipal() {
    ...
    do {
        ...
        printf("5. Salir (Terminar ejecución)\n");
        printf("Ingrese una opción: ");
        scanf("%d", &opcion);
        ...
        switch (opcion) {
            ...
            case 3:
                ...
                break;
            case 4:
                cargarUsuariosDesdeArchivo(usuarios, "../resources/check.csv");
                listarUsuarios(usuarios);
                break;
            case 5:
                printf("Terminando ejecución del programa.\n");
...
/*
void iniciarSesion(Usuario usuarios[], int contadorUsuarios) {
    char nombreUsuario[50];
    printf("Ingrese el nombre del usuario: ");
    scanf("%s", nombreUsuario);
    ...
    submenuUsuario(usuarios, contadorUsuarios, indiceUsuario);
}
